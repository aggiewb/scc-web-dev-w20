...
<html>
    ...
    <body>
        ...
        <p>This section demonstrates sorting an array without the use of a built in PHP function. Instead it uses a personally built function that takes an array as argument and returns the sorted array. Both the unsorted and sorted array will be printed using the print_r function.</p>
